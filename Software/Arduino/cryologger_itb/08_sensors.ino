...
void readLsm303() {
  ...
  if (online.lsm303 && online.lis2mdl) {
    ...
    DEBUG_PRINT("pitch: ");
    DEBUG_PRINTLN_DEC(pitch, 2);
    DEBUG_PRINT("roll: ");
    DEBUG_PRINTLN_DEC(roll, 2);
    DEBUG_PRINT("heading: ");
...
void readBme280() {
  ...
  if (online.bme280) {
    ...
    DEBUG_PRINT("temperatureInt: ");
    DEBUG_PRINTLN_DEC(temperatureInt, 2);
    DEBUG_PRINT("humidityInt: ");
    DEBUG_PRINTLN_DEC(humidityInt, 2);
    DEBUG_PRINT("pressureInt: ");
    DEBUG_PRINTLN_DEC(pressureInt, 2);
