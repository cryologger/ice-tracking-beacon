...
?>
      ...
      function initMap() {
        ...
        google.maps.event.addDomListener(document.getElementById('2'), 'click', function () {
          map.setCenter(new google.maps.LatLng(73.539287,-73.966668));
          map.setZoom(7)
        });
        ...
        var infoWindow = new google.maps.InfoWindow;
          ...
          downloadUrl('http://cryologger.org/xmlMarker.php', function(data) {
          ...
          // Change this depending on the name of your PHP or XML file
          downloadUrl('http://cryologger.org/xmlPolyline.php', function(data) {
            var xml = data.responseXML;
    ...
    <body>
      <div id="tabs">
        <ul>
          ...
          <li><a href="#tab-4"><span>Contact</span></a></li>
        </ul>
        ...
        <div id="tab-4">
            <ul>
                <li>Email: adam.garbo@carleton.ca</li>
                <li>GitHub: https://github.com/adamgarbo</li>
            </ul>
        </div>
